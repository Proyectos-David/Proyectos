...
\begin{demo}
  ...
  \begin{longderivation}<1.1>
      \res{\Forall{r}[r\in\R^+]{ |h|<r}}\\
    \equiv\\
      \res{\Forall{r}[r\in\R^+]{ |a\,h| < |a|\,r}}\\
    \why[\To]{$|a|\,r \in \R^+$}\\
      \res{\Forall{r'}[r'\in\R^+]{|a\,h| < r'}}\\
    \equiv\\
      \res{a\,h \in M_1}
  \end{longderivation}
  Sea $a\in M_0 - M_1$, por definición, se tiene que:
  \begin{longderivation}<.9>
      \res{\Exists{r_1,r_2}[r_1,r_2\in\R^+]{r_1 < |a| < r_2}}\\
    \equiv\\
      \res{\Exists{r_1,r_2}[r_1,r_2\in\R^+]{\frac{1}{r_1} > \frac{1}{|a|} > \frac{1}{r_2}}}\\
    \equiv\\
      \res{\frac{1}{a}\in M_0 - M_1}
  \end{longderivation}
...
\begin{demo}
  ...
  \begin{longderivation}
      \res{r_1 - r_2 \in M_1 \land |r_1 - r_2| \not= 0}\\
    \To\\
      \res{ |r_1 - r_2| < |r_1 - r_2| }
  \end{longderivation}
